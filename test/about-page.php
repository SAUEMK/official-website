...
<?php 
 $fotosor=$db->prepare("SELECT * FROM galeri_foto WHERE foto_durum NOT IN (0) order by rand() limit 4");
 $fotosor->execute();
              ...
              <div class="col-sm-3 col-xs-6">
                        <div class="fw-image">
                            <a href="<?php echo $fotocek['foto']; ?>" data-lity>
                                <img style="" src="<?php echo $fotocek['foto']; ?>" alt="">
                            </a>
                        </div>
                        </div>
                    <?php }
